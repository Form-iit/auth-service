...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public String ChangeCurrentUserPassword(String oldPassword, String newPassword) throws UserNotFoundException, BadCredentialsException {
        String encodedOldPassword = passwordEncoder.encode(oldPassword);
        String userId = getCurrentUserId();
        User user = authRepo.findById(userId).orElseThrow(() -> new UserNotFoundException("User was not found"));
    ...
    public String DeleteCurrentUser() throws UserNotFoundException{
        ...
        User userToDelete = authRepo.findById(userId).orElseThrow(() -> new UserNotFoundException("User was not found"));

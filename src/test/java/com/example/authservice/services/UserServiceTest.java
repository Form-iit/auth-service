...
public class UserServiceTest {
    ...
    class UserData {
        ...
        public void UserDataNotFound() {
            //!Mock
            when(authRepo.findById(currentUser.getId())).thenThrow(new UserNotFoundException("User not found"));

            //!Act & Assert
            UserNotFoundException ex = assertThrows(UserNotFoundException.class, () -> userService.getUserData());
    ...
    class UpdateUserData {
        ...
        public void FailedEditUserDataTest() {
            ...
            //!Act & Assert
            UserNotFoundException ex= assertThrows(UserNotFoundException.class, () -> userService.EditUserData(inputUserDto));
    ...
    class ChangeUserPassword {
        ...
        public void SuccessfulChangePasswordTest() {
            //!Arrange (continuation)
            String encodedOldPassword = currentUser.getPassword(); //* This represents the current password in the DB (encoded)
        ...
        public void UserNotFoundTest() {
            ...
            //!Act
            UserNotFoundException ex = assertThrows(UserNotFoundException.class, ()-> userService.ChangeCurrentUserPassword(oldPassword, newPassword));
        ...
        public void OldPasswordNotMatching(){
            ...
            //!Act & Assert
            BadCredentialsException ex = assertThrows(BadCredentialsException.class, ()-> userService.ChangeCurrentUserPassword(oldPassword, newPassword));
    ...
    class DeleteUser {
        ...
        public void UserNotFound(){
            ...
            //!Act & Assert
            UserNotFoundException ex = assertThrows(UserNotFoundException.class, ()-> userService.DeleteCurrentUser());
            assertEquals("User not found", ex.getMessage());

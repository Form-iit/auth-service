...
public class AuthorizationResponseOperationCustomizer implements OperationCustomizer {
  ...
  public Operation customize(Operation operation, HandlerMethod handlerMethod) {
    ...
    if (annotation != null) {
      ...
      EnumMap<AuthorizationResponses.ExampleType, Example> exampleMap =
          new EnumMap<>(AuthorizationResponses.ExampleType.class);
      exampleMap.put(
          AuthorizationResponses.ExampleType.AUTHORIZATION_DENIED,
          createExample(
              "AuthorizationDeniedException",
              "This is the error returned when the user is authenticated but doesn't have the"
                  + " required permissions or roles to access the resources",
              """
              {
              ...
              """));
      exampleMap.put(
          AuthorizationResponses.ExampleType.INSUFFICIENT_AUTHENTICATION,
          createExample(
              "InsufficientAuthenticationException",
              "This is the error returned when trying to access a protected resource while being"
                  + " un-authenticated",
              """
              {
              ...
              """));
      exampleMap.put(
          AuthorizationResponses.ExampleType.EXPIRED_JWT,
          createExample(
              "ExpiredJwtException",
      ...
      ApiResponse apiResponse =
          new ApiResponse().description("Unauthorized or access denied").content(content);

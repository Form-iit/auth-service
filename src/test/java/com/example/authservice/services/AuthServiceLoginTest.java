...
public class AuthServiceLoginTest {
    ...
    public void loginWithInvalidCredentials() {
        ...
        //!Mock
        when(authManager.authenticate(new UsernamePasswordAuthenticationToken(authRequest.getEmail(), authRequest.getPassword()))).thenThrow(BadCredentialsException.class);
    ...
    public void successfulLogin() {
        ...
        verify(authManager).authenticate(new UsernamePasswordAuthenticationToken(authRequest.getEmail(), authRequest.getPassword()));

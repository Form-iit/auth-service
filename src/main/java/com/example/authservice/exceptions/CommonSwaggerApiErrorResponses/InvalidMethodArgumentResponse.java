              ...
              @Content(
                  ...
                  examples =
                      @ExampleObject(
                          ...
                          description =
                              "This error response is returned whenever one or more arguments"
                                  + " passed to a controller don't respect the imposed validation"
                                  + " rules",
                          value =
                              "{\n"
                                  + "  \"type\": \"MethodArgumentNotValidException\",\n"
                                  + "  \"message\": \"Validation failed for one or more"
                                  + " fields.\",\n"
                                  + "  \"errors\": {\n"
                                  + "    \"field 1\": [\n"

...
public class UserControllerTest {
    ...
    class ChangeUserPasswordTest {
        ...
        public void editUserPassword() {
            //!Mock
            when(userService.ChangeCurrentUserPassword(req.getOldPassword(), req.getNewPassword())).thenReturn(currentUser.getUsername()); //? the getUsername returns the ID
            //!Act
        ...
        public void PasswordChangeError() {
            //!Mock
            when(userService.ChangeCurrentUserPassword(req.getOldPassword(), req.getNewPassword())).thenThrow(BadCredentialsException.class);
            //!Act & Assert
            assertThrows(BadCredentialsException.class, () -> userController.EditUserPassword(req));
            //!Verify
            verify(userService, times(1)).ChangeCurrentUserPassword(req.getOldPassword(), req.getNewPassword());
        }
    }

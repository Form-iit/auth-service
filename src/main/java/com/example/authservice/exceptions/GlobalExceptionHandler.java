...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UserNotFoundException.class, UserAlreadyExistsException.class, AuthenticationException.class, JwtException.class, RoleNotFoundException.class, AccessDeniedException.class, NoResourceFoundException.class})
    public ResponseEntity<Object> handleCustomExceptions(Exception ex) {
        Map<String, Object> responseBody = new HashMap<>();
        //? Unwrap the exception if it's an InternalAuthenticationServiceEx to expose the underlying cause which is EmailNotFoundEx
        Throwable cause = ex;
        ...
        HttpStatus status = switch (exceptionClassName) {
            ...
            case "BadCredentialsException", "ExpiredJwtException", "SignatureException", "InsufficientAuthenticationException", "AccessDeniedException" -> HttpStatus.UNAUTHORIZED;

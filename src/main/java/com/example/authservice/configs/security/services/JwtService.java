...
public class JwtService {
    ...
    private <T> T extractClaim(String token, Function<Claims, T> claimsResolver) {
        ...
        return claimsResolver.apply(claims); //? the resolver will be a function which extracts the claim by given name
    }
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .expiration(new Date(System.currentTimeMillis() + 60 * 60 * 1000)) //* sets an expiration date for the token 1 hour from now.and()
                .and()
